...
class APIController extends Controller
{
    ...
    {
        $count = Order::where('ticket_number', $request->json('number'))->where('play_id', $request->json('play_id'))->whereDate('play_date', Carbon::parse($request->json('play_date')))->get()->count();
        return response()->json([
            'status' => true,
            'count' => $count,
            'message' => 'success',
